...
public class AppBase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        divisions.add("S1 SOFTWARE ENGINEERING");
        divisions.add("S2 LAW FOR ENGINEERS");
        divisions.add("S3 CAPSTONE");

        gridView = (GridView)findViewById(R.id.grid);
        basicFields.add("ATTENDANCE");
        basicFields.add("SEARCH AND STATS");
        basicFields.add("ADD STUDENT");
        basicFields.add("VIEW ATTENDANCE");
